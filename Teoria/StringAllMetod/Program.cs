...
namespace StringAllMetod
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ////Compare two string value and returns 0 for true and 1 fo false



            // Console.WriteLine(firstname.Contains("ven")); //Check whether specified value exists or not in string

            //  Console.WriteLine(firstname.EndsWith("k")); //Check whether specified value is the last character of string
